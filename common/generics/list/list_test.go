...
func checkListLen(t *testing.T, l *List[int], len int) bool {
	if n := l.Len(); n != len {
...
func checkListPointers(t *testing.T, l *List[int], es []*Element[int]) {
	root := &l.root
