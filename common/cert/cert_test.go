...
func TestCert(t *testing.T) {
	ca, privateKey, err := generateCert("Clash Test Root CA", true, nil, nil)
	...
	assert.Equal(t, []x509.ExtKeyUsage{x509.ExtKeyUsageServerAuth, x509.ExtKeyUsageClientAuth}, x509c.ExtKeyUsage)
