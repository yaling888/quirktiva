...
require (
	...
	github.com/apernet/hysteria/core/v2 v2.7.1 // indirect
	github.com/apernet/hysteria/extras/v2 v2.7.1 // indirect
...
replace (
	github.com/apernet/quic-go => github.com/yaling888/quic-hy2 v0.59.100
