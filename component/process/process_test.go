...
func getExePath(path string) (string, error) {
	...
	if runtime.GOOS == "darwin" {
		if strings.HasPrefix(path, "/private") && !strings.HasPrefix(exePath, "/private") {
			exePath = filepath.Join("/private", exePath)
		}
	}
